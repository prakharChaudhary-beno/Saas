...
exports.createPolicy = async (req, res, next) => {
  try {
    const data = await service.createPolicy(req.body, req.user, req.query);
...
exports.getPolicyById = async (req, res, next) => {
  try {
    const data = await service.getPolicyById(req.params.id, req.user, req.query);
...
exports.updatePolicy = async (req, res, next) => {
  try {
    const data = await service.updatePolicy(req.params.id, req.body, req.user, req.query);
...
exports.activatePolicy = async (req, res, next) => {
  try {
    const data = await service.activatePolicy(req.params.id, req.user, req.query);
...
exports.deactivatePolicy = async (req, res, next) => {
  try {
    const data = await service.deactivatePolicy(req.params.id, req.user, req.query);
...
exports.archivePolicy = async (req, res, next) => {
  try {
    const data = await service.archivePolicy(req.params.id, req.user, req.query);
...
exports.deletePolicy = async (req, res, next) => {
  try {
    const data = await service.deletePolicy(req.params.id, req.user, req.query);
...
exports.getVersionHistory = async (req, res, next) => {
  try {
    const data = await service.getVersionHistory(req.params.id, req.user, req.query);
...
exports.getVersionSnapshot = async (req, res, next) => {
  try {
    const data = await service.getVersionSnapshot(req.params.id, req.params.version, req.user, req.query);
...
exports.restoreVersion = async (req, res, next) => {
  try {
    const data = await service.restoreVersion(req.params.id, req.params.version, req.user, req.query);
